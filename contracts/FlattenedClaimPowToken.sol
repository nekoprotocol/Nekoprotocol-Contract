...
// File: contracts\INekoProtocolToken.sol
...
// File: contracts\IManekiNeko.sol

pragma solidity ^0.8.0;

interface IManekiNeko {
    function claimTokenomic(uint8 _indexTokenomic, address _to, uint _amount) external;
}

// File: contracts\ClaimPowToken.sol
